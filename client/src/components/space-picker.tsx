...
export function SpacePicker({ onClose }: SpacePickerProps = {}) {
  ...
  return (
    <TooltipProvider>
      <div className="w-20 bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col-reverse items-center py-4 space-y-reverse space-y-4 transition-all duration-300">
