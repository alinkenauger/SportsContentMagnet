  ...
  return (
    <div className="min-h-screen text-slate-900" style={pageStyles}>
      <header className="border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-4xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          ...
          {stage !== "welcome" && stage !== "result" && (
            <div className="w-32 sm:w-48" aria-label={`${Math.round(progress)}% complete`}>
      ...
      <main className="mx-auto flex min-h-[calc(100vh-74px)] max-w-4xl items-center px-4 py-8 sm:px-6 sm:py-12">
        ...
        {stage === "result" && result && (
          <section className="w-full" aria-labelledby="result-heading">
            <div className="grid gap-6">
                  ...
                  <div className="mx-auto max-w-3xl">
                    <div className="text-center">
                      ...
                      <h1
                        ...
                        id="result-heading"
                        tabIndex={-1}
                        className="text-balance text-3xl font-bold tracking-tight text-slate-950 outline-none sm:text-4xl"
                      >
                        {result.outcome.title}
                      </h1>
                      <p className="mx-auto mt-4 max-w-2xl text-lg font-medium leading-7 text-slate-700">
                        {result.outcome.summary}
                      </p>
                    </div>

                    <div className="mt-9 rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-7">
                        ...
                        <div className="mt-4 grid gap-3">
                          {result.outcome.recommendations.map((recommendation, index) => (
                            ...
                            >
                              ...
                              <p className="pt-0.5 leading-6 text-slate-700">{recommendation}</p>
                            </div>
                          ))}
                        </div>
                      </div>
              ...
              {(result.gift || result.cta) && (
                <div className="grid gap-5 lg:grid-cols-2">
                  {result.gift && (
                    <Card className="overflow-hidden border-amber-200 bg-gradient-to-br from-amber-50 to-white shadow-sm">
                      <CardContent className="p-6 sm:p-7">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <Badge className="mb-2 bg-amber-100 text-amber-800 hover:bg-amber-100">Your free gift</Badge>
                        ...
                        {result.gift.url && (
                          <Button asChild className="mt-6 w-full bg-amber-500 text-slate-950 hover:bg-amber-400">
                            <a
                              href={result.gift.url}
                              target="_blank"
                              rel="noopener noreferrer"
                              onClick={() => trackResultClick("gift")}
                            >
                    ...
                    <Card className="overflow-hidden border-blue-200 bg-gradient-to-br from-blue-50 to-white shadow-sm">
                      <CardContent className="p-6 sm:p-7">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <Badge className="mb-2 bg-blue-100 text-blue-800 hover:bg-blue-100">Keep moving forward</Badge>
                            <h2 className="text-xl font-bold text-slate-950">
                        ...
                        {result.cta.url && (
                          <Button asChild className="mt-6 w-full text-white" style={{ backgroundColor: primaryColor }}>
                            <a
                              href={result.cta.url}
                              target="_blank"
                              rel="noopener noreferrer"
                              onClick={() => trackResultClick("cta")}
                            >
